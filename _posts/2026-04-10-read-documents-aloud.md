...
3. Select your TTS app from the share sheet
4. The document opens ready to play

### From Email Attachments

1. Open the email in Mail or Gmail
2. Tap the attachment to preview it
3. Tap the Share icon and select your TTS app

### From Cloud Storage (Google Drive, Dropbox)

1. Tap the three-dot menu on the file
2. Select **Open in** or **Share**
3. Choose your TTS app

### From a Web Browser

1. Open the article in Safari
2. Tap the Share icon
3. Select your TTS app from the sheet
